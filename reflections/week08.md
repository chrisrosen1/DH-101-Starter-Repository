...
In my network map, the visible items are the apps I use, the companies behind them, and the types of data connected to those platforms. Apps like Gmail, Google Search, YouTube, Instagram, Amazon, and Spotify are easy to see because they are the tools people interact with every day. The companies behind them, such as Google, Meta, and OpenAI, are also visible in the network.
